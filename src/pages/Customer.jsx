...
const Customer = () => {
    return (
        <div className='w-[80%] mx-auto container'>
                        ...
                        <div className="-my-6 divide-y divide-gray-200 dark:divide-gray-800">
                            <div className="space-y-4 py-6 md:py-8">
                                <div className="grid gap-4">
                                    ...
                                    <Link to="#" className="text-xl font-semibold text-gray-900 hover:underline dark:text-white">“The specs say this model has 2 USB ports. The one I received has none. Are they hidden somewhere?”</Link>
                                </div>
                                ...
                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                                    ...
                                    <Link to="#" className="text-gray-900 hover:underline dark:text-white">Bonnie Green</Link>
                                </p>
                            </div>
                            ...
                            <div className="space-y-4 py-6 md:py-8">
                                <div className="grid gap-4">
                                    ...
                                    <Link to="#" className="text-xl font-semibold text-gray-900 hover:underline dark:text-white">“Is this just the monitor?”</Link>
                                </div>
                                ...
                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                                    Answered 1 day ago by
                                    <Link to="#" className="text-gray-900 hover:underline dark:text-white">Jese Leos</Link>
                                </p>
                            </div>
                            ...
                            <div className="space-y-4 py-6 md:py-8">
                                <div className="grid gap-4">
                                    ...
                                    <Link to="#" className="text-xl font-semibold text-gray-900 hover:underline dark:text-white">“For an inexpert 85-year-old general user with a ten-year old iMac (OSX Yosemite version 10.10.5), is this latest model 24" iMac with Retina 4.5K display Apple M1 8GB memory - 256GB SSD a decent upgrade?”</Link>
                                </div>
                            ...
                            <div className="space-y-4 py-6 md:py-8">
                                <div className="grid gap-4">
                                    ...
                                    <Link to="#" className="text-xl font-semibold text-gray-900 hover:underline dark:text-white">“I just brought home the Imac24". It saysthe mouse and Keyboard are wireless. Where do I install the power for them?”</Link>
                                </div>
                                ...
                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                                    Answered 2 days ago by
                                    <Link to="#" className="text-gray-900 hover:underline dark:text-white">Roberta Casas</Link>
                                </p>
                            </div>
                            ...
                            <div className="space-y-4 py-6 md:py-8">
                                <div className="grid gap-4">
                                    ...
                                    <Link to="#" className="text-xl font-semibold text-gray-900 hover:underline dark:text-white">“Does this include the keyboard and mouse?”</Link>
                                </div>
                                ...
                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                                    ...
                                    <Link to="#" className="text-gray-900 hover:underline dark:text-white">Joseph McFallen</Link>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div id="question-modal" tabindex="-1" aria-hidden="true" className="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden antialiased antialiased md:inset-0">
                        ...
                        <form className="p-4 md:p-5">
                            <div className="mb-4 grid grid-cols-2 gap-4">
                                <div className="col-span-2">
                                    <label for="question" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Your question <span className="text-gray-500 dark:text-gray-400">(150-1000 characters)</span></label>
                                    <textarea id="question" rows="6" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" required="" />
                                </div>
                                <div className="col-span-2 grid gap-4 md:grid-cols-2">
                                    <div>
                                        <label for="question-type" className="mb-2 flex items-center text-sm font-medium text-gray-900 dark:text-white">
                                    ...
                                    <div>
                                        <label for="priority-type" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Priority</label>
                                ...
                                <div className="col-span-2">
                                    ...
                                    <div className="flex w-full items-center justify-center">
                                        <label for="dropzone-file" className="dark:hover:bg-bray-800 flex h-48 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                ...
                                <div className="col-span-2">
                                    <div className="flex items-center">
                                        ...
                                        <label for="link-checkbox" className="ms-2 text-sm font-medium text-gray-500 dark:text-gray-400">I have read and agree with the <Link to="#" className="text-primary-600 hover:underline dark:text-primary-500">terms and conditions</Link>.</label>
                                    </div>
                                </div>
                            </div>
